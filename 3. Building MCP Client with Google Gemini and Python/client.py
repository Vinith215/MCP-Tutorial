...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        print(f"Launching server: {command} {server_script_path}")
...
def convert_mcp_tools_to_gemini(mcp_tools):
    ...
    for tool in mcp_tools:
        ...
        function_declaration = types.FunctionDeclaration(
            ...
            description=tool.description,  # Description of what the tool does
            parameters=parameters  # Convert MCP schema to Gemini format
        )
